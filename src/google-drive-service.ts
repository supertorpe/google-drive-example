...
export async function findFolder(folderName: string, token: string): Promise<string | undefined> {
...
export async function findFile(filename: string, folderId: string, token: string): Promise<string | undefined> {
    try {
        const url = 'https://www.googleapis.com/drive/v3/files';
        const queryParams = {
...
export async function getFileContent(fileId: string, token: string): Promise<string | undefined> {
    try {
